...
public class EventInstance : HandleBase
{
	...
	{
		return WRAP_FMOD_Studio_EventInstance_SetParameterByName_2(rawPtr, Encoding.UTF8.GetBytes(name + "\0"), value);
	}
	...
	*/
	...
	[DllImport("fmodstudio")]
	private static extern RESULT WRAP_FMOD_Studio_EventInstance_SetParameterByName_2(IntPtr _event, byte[] name, float value);
