...
public class Error
{
	public static string String(RESULT errcode)
	{
		return errcode switch
		{
			...
			RESULT.ERR_MEMORY_CANTPOINT => "Can't use WRAP_FMOD_OPENMEMORY_POINT on non PCM source data, or non mp3/xma/adpcm data if FMOD_CREATECOMPRESSEDSAMPLE was used.", 
			...
			RESULT.ERR_OUTPUT_NODRIVERS => "The output device has no drivers installed.  If pre-init, WRAP_FMOD_OUTPUT_NOSOUND is selected as the output mode.  If post-init, the function just fails.", 
			...
			RESULT.ERR_REVERB_INSTANCE => "Specified instance in WRAP_FMOD_REVERB_PROPERTIES couldn't be set. Most likely because it is an invalid instance number or the reverb doesn't exist.", 
